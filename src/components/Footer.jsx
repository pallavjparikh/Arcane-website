            ...
            <footer>
                <div className="footerFlex">
                    <div>
                        ...
                        <p>Contact us at: <a href="mailto:pallav@thearcaneai.com">pallav@thearcaneai.com</a></p>
                    </div>
                    <div className='footerLinks'>
                        ...
                        <ul>
                            <li>Contact</li>
                            <li><a href="mailto:pallav@thearcaneai.com">Email</a></li>
                            <li><a href="https://pallav.ca" target='_blank'>Personal Website</a></li>
                        </ul>
                    </div>
                </div>
